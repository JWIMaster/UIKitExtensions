...
open class CustomBlurEffectView: UIView {
    ...
    /// Blur effect for IOS < 14
    private lazy var customBlurEffect: UIKit.UIBlurEffect = {
        return (NSClassFromString("_UICustomBlurEffect") as! UIKit.UIBlurEffect.Type).init()
    }()
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activateCompat([
